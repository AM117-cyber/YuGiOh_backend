        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainCards = table.Column<int>(type: "integer", nullable: false),
                    ExtraCards = table.Column<int>(type: "integer", nullable: false),
                    SideCards = table.Column<int>(type: "integer", nullable: false),
                    MyStatus = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Decks_AspNetUsers_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tournaments_AspNetUsers_AdministrativeUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tournaments_AdministrativeUserId",
                table: "Tournaments",
